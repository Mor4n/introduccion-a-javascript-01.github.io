...
- **./index.html**: Archivo HTML del proyecto, contectando el script.js y el style.css
- **./script.js**: Archivo de Javascript con la funcionalidad del proyecto
- **./style.css**: Archivo de CSS con los estilos del proyecto

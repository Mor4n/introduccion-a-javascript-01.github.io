...
![Captura inicial del programa](./img/Captura1.png)
![Captura con datos en los inputs](./img/Captura2.png)
![Captura con comentarios añadidos](./img/Captura3.png)
![Captura con comentario 2 eliminado](./img/Captura4.png)
...
Se implementó el local storage como lo vimos en clase y para borrar fue donde llegué a tener el problema jsjs, pero lo hice con el método filter del arreglo de comentarios.
Es algo que no conocía, pero con este método puedo crear una nueva lista en base a un filtro, por ejemplo, en mi código tengo el "array_comment", el cual son los comentarios que actualmente existen en el arreglo y "comment" que es el comentario actual al que le di click para eliminar, entonces filtro el arreglo de comentarios, dejo los que no tengan el mismo id que el comentario al que le di click, y lo guardo en un nuevo arreglo, así técnicamente excluyo el comentario a desear del arreglo de comentarios, y luego este nuevo arreglo lo coloco en el localstorage con setItem y convirtiendo el objeto en un texto.
Esta fue una de las formas con menos código y más fáciles que estuve viendo en cuanto a eliminar un item de un arreglo que vi ;u;